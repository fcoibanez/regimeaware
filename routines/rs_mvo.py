...
from regimeaware.modules.rs_portfolio_opt.rsopt import dataload as dl
from tqdm import tqdm
import random
import argparse
from regimeaware.modules.rs_portfolio_opt.rsopt import portfolio as po
...
if __name__ == "__main__":
    ...
    for phi in SimulationParameters.RISK_AVERSION.value:
        for i in iterations:
            fname = f"{DataConstants.WDIR.value}/results/rs_mvo/phi{phi}_iter{i}.pkl"
            ...
            for t in tqdm(
                ...
                # TODO: frets
                # TODO: riskfree (zeroes in my case)
                # TODO: arets (asset returns)
                # TODO: data.freq (frequency string)

                prt = po.Portfolio(
                    name="rsmvo",
                    assets=list(range(SimulationParameters.NUM_STOCKS.value)),
                ...
                po.backtest(
                    ...
                    n_states=HMMParameters.STATES.value
                )
